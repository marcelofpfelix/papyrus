...
const generatedNoiseMask2 = join(root, "public/generated/dithernoise/images/papyrus-image-effects-demo-2.png");
const generatedNoiseLightMask2 = join(root, "public/generated/dithernoise/images/papyrus-image-effects-demo-2-light.png");
...
assert(post.includes("papyrus-image-effects-demo-2-light.png"), "demo post should reference the animated noise mask frame");
...
assert(css.includes("--papyrus-active-dither-mask-2") && css.includes("papyrusDitherNoiseAlternate"), "dithernoise CSS should swap between generated noise masks");
...
const noiseMask2 = await stat(generatedNoiseMask2);
assert(noiseMask2.size > 0, "dithernoise animation mask should be generated and non-empty");
const noiseLightMask2 = await stat(generatedNoiseLightMask2);
assert(noiseLightMask2.size > 0, "light dithernoise animation mask should be generated and non-empty");
